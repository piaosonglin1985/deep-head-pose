...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, input_size=224, width_mult=1.):
        ...
        for t, c, n, s in self.cfgs:
            ...
            self.layers.append(block(input_channel, output_channel, s, t))
...
if __name__ == '__main__':
    net = MobileNetV2()
    net.load_state_dict(torch.load('/home/songlin/deeplearning/head_pose/mobilenetv2_1.0-0c6065bc.pth'))
